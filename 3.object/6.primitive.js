...
//객체를 문자형태로 바꾸는 작업: serializing

//object -> 기본타입
let date1 = new Date(2023, 2, 7)
let date2 = new Date(2023, 2, 6)

console.log(date1 - date2) //결과값은 ms단위이다. (86400초 = 1440분 = 24시간)

let user = {
    userName: 'amanda',
    age: 20,
    //symbol type을 나타낼 때 []를 쓴다. toPrimitive는 method. hint를 parameter로 받아서 return.
...
console.log(user > user2) //parameter로 string 아닌 값이 들어가기때문에 age를 return받아 값을 비교한다.
console.log(user + 50)
