...
//node가 넣어줄 callback parameter 2개를 기술한다.
 //실행되면, Promise객체의 state의 value가 resolved로 바뀌고, 
...
promise.catch(console.log)//reject handler만 등록하고 싶을때 쓴다.
...
promise.then(result => console.log(1, result),
            result => console.log(2, result)) //resolve handler, error handler 준비.